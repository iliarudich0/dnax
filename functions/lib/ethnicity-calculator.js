...
exports.ANCESTRY_MARKERS = void 0;
exports.calculateEthnicity = calculateEthnicity;
 ...
 */
function calculateEthnicity(snps) {
    const scores = {};
    let markersUsed = 0;
    // Initialize scores
    ...
    for (const snp of snps) {
        const markerData = exports.ANCESTRY_MARKERS[snp.rsid];
        if (!markerData)
            continue;
        markersUsed++;
    ...
    return {
        ...
        total_markers: Object.keys(exports.ANCESTRY_MARKERS).length
    };
}
/**
 ...
 */
function getMarkerInfo(rsid) {
    const marker = exports.ANCESTRY_MARKERS[rsid];
    if (!marker)
        return null;
    return {
        rsid,
 ...
 */
function getMarkerDescription(rsid) {
    const descriptions = {
...
//# sourceMappingURL=ethnicity-calculator.js.map